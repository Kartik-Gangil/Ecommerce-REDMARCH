...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <nav className={`px-6 py-4 bg-white text-black backdrop-blur-sm fixed w-full z-50 shadow-md ${scrollDirection === "down" ? "top-0" : "top-14 md:top-9"} transition-all duration-200`}>
                <div className="flex items-center justify-between w-full">
                    ...
                    <div className="hidden md:flex space-x-6">
                        ...
                        <Link to="/soon" className="hover:font-bold hover:text-[#991B1B] text-gray-600 transition-all duration-300">Story</Link>
                        <Link to="/soon" className="hover:font-bold hover:text-[#991B1B] text-gray-600 transition-all duration-300">About</Link>
                        <Link to="/soon" className="hover:font-bold hover:text-[#991B1B] text-gray-600 transition-all duration-300">Contact</Link>
                    </div>
                ...
                {mobileOpen && (
                    ...
                    `}>
                        ...
                        <Link to="/soon" className="hover:text-[#991B1B] text-gray-600 transition-colors">About</Link>
                        <Link to="/soon" className="hover:text-[#991B1B] text-gray-600 transition-colors">Contact</Link>
                    </div>
                )}
            </nav>
        </>
